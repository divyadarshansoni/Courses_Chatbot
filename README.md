# IITB Courses AI Chat

Quickly summarize the content of Course Info Booklet and get the information you need in **real-time** from private large unstructured documents in your [Dropbox](https://dropbox.com/). The same tool can be used with [OneDrive](https://onedrive.live.com/login/).
...
```bash
git clone https://github.com/divyadarshansoni/Courses_Chatbot
```
